    ...
    <div class="clearfix content">
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <article>
                    <div align="center" style="height:auto; background:url(imagenes/tentativas/yellow-card.jpg); background-size:cover; background-position: top; margin-top:-20px; border-bottom:1px solid #CCC;">
                    	<h3 style="padding-top:30px; color:#FFF; font-size:8em; text-shadow:2px 2px 2px #131313; font-family: 'box';">Amonestados</h3>
                    ...
                    <div class="centered-pills"> 
                        ...
                        <div align="center">
                        	<div id="resultadosAmarillas" style="font-size:1.3em; width:70%;">
...
$(document).ready(function(){
	...
	$('#zonaAtoneoA').click(function() {
		TraerResultadosAmarillasAcumuladas(1,19,<?php echo $IdUltimaFecha; ?>,'Zona A');
		$('#zonaExp').html('Zona A');
	});
	
	
	$('#zonaBtoneoA').click(function() {
		TraerResultadosAmarillasAcumuladas(1,20,<?php echo $IdUltimaFecha; ?>,'Zona B');
		$('#zonaExp').html('Zona B');
	});
	
	$('#zonaCtoneoA').click(function() {
		TraerResultadosAmarillasAcumuladas(1,21,<?php echo $IdUltimaFecha; ?>,'Zona C');
		$('#zonaExp').html('Zona B');
	});
	
	
	$('#zonaAtoneoB').click(function() {
		TraerResultadosAmarillasAcumuladas(2,19,<?php echo $IdUltimaFechaB; ?>,'Zona A');
		$('#zonaExp').html('Zona A');
	});
	
	
	$('#zonaBtoneoB').click(function() {
		TraerResultadosAmarillasAcumuladas(2,20,<?php echo $IdUltimaFechaB; ?>,'Zona B');
		$('#zonaExp').html('Zona B');
	});
	
	$('#zonaCtoneoB').click(function() {
		TraerResultadosAmarillasAcumuladas(2,21,<?php echo $IdUltimaFechaB; ?>,'Zona C');
		$('#zonaExp').html('Zona C');
	});
	
	
	$('#zonaAtoneoC').click(function() {
		TraerResultadosAmarillasAcumuladas(3,19,<?php echo $IdUltimaFechaC; ?>,'Zona A');
		$('#zonaExp').html('Zona A');
	});
	
	
	$('#zonaBtoneoC').click(function() {
		TraerResultadosAmarillasAcumuladas(3,20,<?php echo $IdUltimaFechaC; ?>,'Zona B');
		$('#zonaExp').html('Zona B');
	});
	
	$('#zonaCtoneoC').click(function() {
		TraerResultadosAmarillasAcumuladas(3,21,<?php echo $IdUltimaFechaC; ?>,'Zona C');
		$('#zonaExp').html('Zona C');
	});
