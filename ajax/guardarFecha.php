<?php
	...
	*/
	if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
		if(isset($_POST['idgrupo']) && isset($_POST['equipoa']) && isset($_POST['equipob']) && isset($_POST['resultadoa']) && isset($_POST['resultadob']) && isset($_POST['idtorneo']) && isset($_POST['fechaj']) && isset($_POST['fecha']) && isset($_POST['hora']) && isset($_POST['minutos'])){
