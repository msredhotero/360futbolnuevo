    ...
    <div class="clearfix content">
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <article>
                    <div align="center" style="height:auto; background:url(imagenes/tentativas/suspendidos3.jpg); background-size:cover; background-position: center; margin-top:-20px; border-bottom:1px solid #CCC;">
                    	<h3 style="padding-top:30px; padding-bottom:20px; color:#FFF; font-size:8em; text-shadow:2px 2px 2px #131313; font-family: 'box';">Suspendidos</h3>
